...
let foodArray = ['tacos', 'pizzas', 'salads'];
...
foodArray.splice(1, 1, 'hamburgers');
console.log('The foods are now', foodArray);
...
const comboArray = foodArray.concat(animalArray);
